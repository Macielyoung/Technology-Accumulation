...
![](D:\GitProject\Technology-Accumulation\Knowledge Graph\pic\RS.png)
...
![](D:\GitProject\Technology-Accumulation\Knowledge Graph\pic\KG.jpg)
...
![](D:\GitProject\Technology-Accumulation\Knowledge Graph\pic\dis-based.png)

* 基于语义的匹配模型（semantic-based matching models）。这类模型使用基于相似度的评分函数评估三元组的概率，将实体和关系映射到隐语义空间中进行相似度度量。这类方法的代表有SME、NTN、MLP、NAM等。

![](D:\GitProject\Technology-Accumulation\Knowledge Graph\pic\semantic-based.png)
